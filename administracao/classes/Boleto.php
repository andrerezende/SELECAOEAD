...
public function Boleto($data_vencimento,$data_documento,
                       $data_processamento,$valor_boleto,
                       $quantidade,$valor_unitario,
                       $aceite,$uso_banco,
                       $especie,$especie_doc,
                       $agencia,$conta,
                       $convenio,$contrato,
                       $formatacao_nosso_numero,$nosso_numero,
                       $numero_documento,$carteira,
                       $variacao_carteira,$cpf_cnpj,
                       $endereco,$cidade,
                       $cedente,$sacado,
                       $endereco1,$endereco2,
                       $instrucoes,$instrucoes1,
                       $instrucoes2,$instrucoes3,
                       $instrucoes4){
