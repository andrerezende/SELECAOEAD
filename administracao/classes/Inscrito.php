...
class Inscrito{
    ...
    */
    ...
    protected $campus               ;
    protected $cadastro_unico;
    protected $data_cadastro;
    protected $ultima_alteracao;

    /*
    public function Inscrito($b,$c,$d,$e,$f,$g,$h,$i,$j,$l,$m,$o,$p,$senha = null,$id = null){
   ...
   */
    ...
    public function Inscrito($pnome, $pendereco, $pbairro, $pcep, $pcidade, $pestado,
            ...
            $pvaga_especial, $pvaga_rede_publica, $pvaga_rural, $pcampus, $pcadastro_unico, $pdata_cadastro, $pultima_alteracao, $pid = null) {
        ...
        $this->campus               = $pcampus              ;
        $this->cadastro_unico       = $pcadastro_unico      ;
    ...
    public function getcadastro_unico() {
        return $this->cadastro_unico;
    }

    public function setcadastro_unico($pcadastro_unico) {
        $this->cadastro_unico = $pcadastro_unico;
    }
    ...
    public function setdata_cadastro($pdata_cadastro) {
        $this->data_cadastro = $pdata_cadastro;
    }
    ...
    public function setultima_alteracao($pultima_alteracao) {
        $this->ultima_alteracao = $pultima_alteracao;
    }

    public function Inserir ($sock){

        //$ssql = "insert into inscrito (nome, endereco, bairro, cep, cidade, estado, email, telefone, celular, cpf, rg, localprova, especial, senha) values ";
		$dataAtual = date('Y-m-d H:i:s');
        $ssql = "insert into inscrito (nome, endereco, bairro, cep, cidade, estado, email, cpf, rg, especial, senha, nacionalidade, telefone, telefone2, celular, datanascimento, sexo, estadocivil, orgaoexpedidor, uf, dataexpedicao, especial_descricao, responsavel, isencao, declaracao, localprova, numinscricao, especial_prova, especial_prova_descricao, vaga_especial, vaga_rede_publica, vaga_rural, campus, cadastro_unico, data_cadastro) values ";
/*
        $ssql = $ssql. "('".$this->nome."',"      ."'".$this->endereco."',";
        $ssql = $ssql. "'".$this->bairro."',"     ."'".$this->cep."',";
        $ssql = $ssql. "'".$this->cidade."',"     ."'".$this->estado."',";
        $ssql = $ssql. "'".$this->email."',"      ."'".$this->telefone."',";
        $ssql = $ssql. "'".$this->celular."',"    ."'".$this->cpf."'," . "'".$this->rg."',";
        $ssql = $ssql. "'".$this->localprova."'," ."'".$this->especial."'," ."'".$this->senha."')";
*/
        $ssql = $ssql. "('".$this->nome."',"      ."'".$this->endereco."',";
        $ssql = $ssql. "'".$this->bairro."',"     ."'".$this->cep."',";
        $ssql = $ssql. "'".$this->cidade."',"     ."'".$this->estado."',";
        $ssql = $ssql. "'".$this->email."',"      ."'".$this->cpf."',";
        $ssql = $ssql. "'".$this->rg."',"         ."'".$this->especial."',"     ."'".$this->senha."',";
        $ssql = $ssql. "'".$this->nacionalidade."',"    ."'".$this->telefone."'," . "'".$this->telefone2."',";
        $ssql = $ssql. "'".$this->celular."',"    ."'".$this->datanascimento."'," . "'".$this->sexo."',";
        $ssql = $ssql. "'".$this->estadocivil."',"    ."'".$this->orgaoexpedidor."'," . "'".$this->uf."',";
        $ssql = $ssql. "'".$this->dataexpedicao."',"    ."'".$this->especial_descricao."'," . "'".$this->responsavel."',";
        $ssql = $ssql. "'".$this->isencao."',";
        $ssql = $ssql. "'".$this->declaracao."'," ."'".$this->localprova."',";
        $ssql = $ssql. "'".$this->numinscricao."',";
        $ssql = $ssql. "'".$this->especial_prova."',"     ."'".$this->especial_prova_descricao."',";
        $ssql = $ssql. "'".$this->vaga_especial."',"     ."'".$this->vaga_rede_publica."',";
        $ssql = $ssql. "'".$this->vaga_rural."',";
        $ssql = $ssql. "'".$this->campus."'," . "'".$this->cadastro_unico . "', '" . $dataAtual . "')";
...
//
//        $ssql = $ssql. " nome = '".$this->nome."',"      ." endereco = '".$this->endereco."',";
//        $ssql = $ssql. "bairro = '".$this->bairro."',"     ."cep = '".$this->cep."',";
//        $ssql = $ssql. "cidade = '".$this->cidade."',"     ."estado = '".$this->estado."',";
//        $ssql = $ssql. "email = '".$this->email."',"      ."telefone = '".$this->telefone."',";
//        $ssql = $ssql. "celular = '".$this->celular."',"    ." cpf = '".$this->cpf."'," . "rg = '".$this->rg."',";
//        $ssql = $ssql. "localprova = '".$this->localprova."'," ."especial = '".$this->especial. "', senha = '".$this->senha."' ";
//
//        $ssql = $ssql. " WHERE id = ".$this->id;
        ...
        $ssql = $ssql. "bairro = '".$this->bairro."',"     ."cep = '".$this->cep."',";
        $ssql = $ssql. "cidade = '".$this->cidade."',"     ."estado = '".$this->estado."',";
        $ssql = $ssql. "email = '".$this->email."',"      ."cpf = '".$this->cpf."',";
        $ssql = $ssql. "rg = '".$this->rg."',"         ."especial = '".$this->especial."',"     ."senha = '".$this->senha."',";
        $ssql = $ssql. "nacionalidade = '".$this->nacionalidade."',"    ."telefone = '".$this->telefone."'," . "telefone2 = '".$this->telefone2."',";
        $ssql = $ssql. "celular = '".$this->celular."',"    ."datanascimento = '".$this->datanascimento."'," . "sexo = '".$this->sexo."',";
        $ssql = $ssql. "estadocivil = '".$this->estadocivil."',"    ."orgaoexpedidor = '".$this->orgaoexpedidor."'," . "uf = '".$this->uf."',";
        $ssql = $ssql. "dataexpedicao = '".$this->dataexpedicao."',"    ."especial_descricao = '".$this->especial_descricao."'," . "responsavel = '".$this->responsavel."',";
        $ssql = $ssql. "isencao = '".$this->isencao."',";
        $ssql = $ssql. "declaracao = '".$this->declaracao."'," ."localprova = '".$this->localprova."'," ."numinscricao = '".$this->numinscricao."',";
        $ssql = $ssql. "especial_prova = '".$this->especial_prova."'," ."especial_prova_descricao = '".$this->especial_prova_descricao."',";
        $ssql = $ssql. "vaga_especial = '".$this->vaga_especial."'," ."vaga_rede_publica = '".$this->vaga_rede_publica."',";
        $ssql = $ssql. "vaga_rural = '".$this->vaga_rural."',";
        $ssql = $ssql. "campus = '".$this->campus."', "."cadastro_unico = '".$this->cadastro_unico."', "."ultima_alteracao = '" . $dataAtual . "'"; //33
...
//        $ssql = $ssql . " WHERE cpf=" .$codigo." AND senha = '" .$senha."'";
        //$ssql = "SELECT nome, endereco, bairro, cep, cidade, estado, email, cpf, rg, especial, senha, nacionalidade, telefone, telefone2, celular, datanascimento, sexo, estadocivil, orgaoexpedidor, uf, dataexpedicao, especial_descricao, responsavel, isencao, declaracao, localprova, numinscricao, id FROM inscrito A " ;
        $ssql = "SELECT nome, endereco, bairro, cep, cidade, estado, email, cpf, rg, especial, senha, nacionalidade, telefone, telefone2, celular, datanascimento, sexo, estadocivil, orgaoexpedidor, uf, dataexpedicao, especial_descricao, responsavel, isencao, declaracao, localprova, numinscricao, especial_prova, especial_prova_descricao, vaga_especial, vaga_rede_publica, vaga_rural, campus, cadastro_unico, data_cadastro, ultima_alteracao, id FROM inscrito A " ;
        $ssql = $ssql . " WHERE cpf=" .$codigo." AND senha = '" .$senha."'";
        ...
        while ($linha = mysql_fetch_row($rs)){
           ...
           //$obj = new Inscrito($linha[0],$linha[1],$linha[2],$linha[3],$linha[4],$linha[5],$linha[6],$linha[7],$linha[8],$linha[9],$linha[10],$linha[11],$linha[12],$linha[13],$linha[14],$linha[15],$linha[16],$linha[17],$linha[18],$linha[19],$linha[20],$linha[21],$linha[22],$linha[23],$linha[24],$linha[25],$linha[26],$linha[27]);
            $obj = new Inscrito($linha[0],$linha[1],$linha[2],$linha[3],$linha[4],$linha[5],$linha[6],$linha[7],$linha[8],$linha[9],$linha[10],$linha[11],$linha[12],$linha[13],$linha[14],$linha[15],$linha[16],$linha[17],$linha[18],$linha[19],$linha[20],$linha[21],$linha[22],$linha[23],$linha[24],$linha[25],$linha[26],$linha[27],$linha[28],$linha[29],$linha[30],$linha[31],$linha[32],$linha[33],$linha[34],$linha[35],$linha[36],$linha[37]);
            $ar[] = $obj;
        }
