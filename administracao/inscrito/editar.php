	...
	<form id='frmeditarinscricao' name='formeditarinscricao' action='atualizar_inscrito.php' method='post' onsubmit='return validar()' >
            <table width="760px" border="0" align="center">
                ...
                <tr>
                    ...
                    <td colspan='2'>
                        <input style="text-transform:uppercase" name="nome" id="nome" type="text" tabindex=1 size='65' maxlength="65" alt="Nome Completo" value="<?echo($objinscrito[0]->getNome()); ?>" />
                ...
                <tr>
                    ...
                    <td>
                        <input name="cpf" type="text" id="cpf" readonly="readonly" tabindex=2 OnKeyPress="javascript:return Onlynumber(event);" value="<?echo($objinscrito[0]->getcpf()); ?>" size="15" maxlength="11" alt="CPF" />
                        <span class="textoSobrescrito">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="senha" id="senha" type="password" tabindex=4 size="15" maxlength="15" alt="Senha" value="<?echo($objinscrito[0]->getsenha()); ?>" />
                        <span class="textoSobrescrito">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="senhaConfirm" id="senhaConfirm" type="password" tabindex=5 size="15" maxlength="15" alt="Confirmar Senha" value="<?echo($objinscrito[0]->getsenha()); ?>" />
                        <span class="textoSobrescrito">*</span>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input name="rg" type="text" id="rg" tabindex=5 OnKeyPress="javascript:return Onlynumber(event);" value="<?echo($objinscrito[0]->getrg()); ?>" size="15" maxlength="11" alt="RG" />
                        <span class="textoSobrescrito">*</span>
                    </td>
                </tr>
...
//                                $vetorcurso = $curso->SelectCursoPorCampus($conexao, $objinscrito[0]->getcampus());
//
//                                /* Varaveis auxiliares */
//                                $i =0;
//
...
//                                  $codigo  = $vetorcurso[$i]->getcodcurso();
...
//                                }
				...
				<tr>
                    ...
                    <td>
                        <input name="nis" id="nis" type="text" size="15" maxlength="11" alt="Cadastro &Uacute;nico (NIS)" OnKeyPress="javascript:return Onlynumber(event);" value="<?php echo($objinscrito[0]->getcadastro_unico()); ?>"/>
                    </td>
                </tr>
