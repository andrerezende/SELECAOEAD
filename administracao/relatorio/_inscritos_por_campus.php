...
<?php
    ...
    header('Content-Disposition: attachment; filename=inscritos_por_campus.xls');
...
echo ("<div class='relatorio'>");
	if (mysql_num_rows($resultado) == 0) {
		...
		echo("  </tr>");
		while ($campus = mysql_fetch_assoc($resultado)) {
			echo("  <tr>");
			echo("    <td>".$campus['nome']."</td>");
			echo("    <td>".$campus['qtd_inscrito']."</td>");
			echo("  </tr>");
		}
		echo("</table>");
	}
